...
public class TruckTableModel extends VerySimpleTableModel<Truck> {
	...
	public TruckTableModel(Window mainWindow, Controllers controllers, SpecialTruckAddons specialTruckAddons, UserDefinedValues udv) {
		super(mainWindow, controllers, new VerySimpleTableModel.ColumnID[] {
				...
				new ColumnID(ID_MetalD   , "Metal Detector"       ,      Data.Capability.class,  90,             null,   null,      null, false, createIsCapableFcn(SpecialTruckAddons.AddonCategory.MetalDetectors  , false)).setVerboseValueFcn( createIsCapableFcn(SpecialTruckAddons.AddonCategory.MetalDetectors  , true) ),
				new ColumnID(ID_Seismic  , "Seismic Vibrator"     ,      Data.Capability.class,  90,             null,   null,      null, false, createIsCapableFcn(SpecialTruckAddons.AddonCategory.SeismicVibrators, false)).setVerboseValueFcn( createIsCapableFcn(SpecialTruckAddons.AddonCategory.SeismicVibrators, true) ),
				new ColumnID(ID_BigCrane , "Big Crane"            ,      Data.Capability.class,  60,             null,   null,      null, false, createIsCapableFcn(SpecialTruckAddons.AddonCategory.BigCranes       , false)).setVerboseValueFcn( createIsCapableFcn(SpecialTruckAddons.AddonCategory.BigCranes       , true) ),
				new ColumnID(ID_MiniCrane, "Mini Crane"           ,      Data.Capability.class,  60,             null,   null,      null, false, createIsCapableFcn(SpecialTruckAddons.AddonCategory.MiniCranes      , false)).setVerboseValueFcn( createIsCapableFcn(SpecialTruckAddons.AddonCategory.MiniCranes      , true) ),
				new ColumnID(ID_LogLift  , "Log Lift"             ,      Data.Capability.class,  50,             null,   null,      null, false, createIsCapableFcn(SpecialTruckAddons.AddonCategory.LogLifts        , false)).setVerboseValueFcn( createIsCapableFcn(SpecialTruckAddons.AddonCategory.LogLifts        , true) ),
